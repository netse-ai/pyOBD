...
cmds = [
    ...
    OBDCommand("TIMING_ADVANCE"             , "Timing Advance"                          , "010E", 1, decoder=None, fast=True),
    OBDCommand("INTAKE_TEMP"                , "Intake Air Temp"                         , "010F", 1, decoder=None, fast=True),
    OBDCommand("MAF"                        , "Air Flow Rate (MAF)"                     , "0110", 2, decoder=None, fast=True),
    OBDCommand("THROTTLE_POS"               , "Throttle Position"                       , "0111", 1, decoder=None, fast=True),
    ...
    OBDCommand("O2_B1S1"                    , "O2: Bank 1 - Sensor 1 Voltage"           , "0114", 2, decoder=None, fast=True),
    OBDCommand("O2_B1S2"                    , "O2: Bank 1 - Sensor 2 Voltage"           , "0115", 2, decoder=None, fast=True),
    OBDCommand("O2_B1S3"                    , "O2: Bank 1 - Sensor 3 Voltage"           , "0116", 2, decoder=None, fast=True),
    OBDCommand("O2_B1S4"                    , "O2: Bank 1 - Sensor 4 Voltage"           , "0117", 2, decoder=None, fast=True),
    OBDCommand("O2_B2S1"                    , "O2: Bank 2 - Sensor 1 Voltage"           , "0118", 2, decoder=None, fast=True),
    OBDCommand("O2_B2S2"                    , "O2: Bank 2 - Sensor 2 Voltage"           , "0119", 2, decoder=None, fast=True),
    OBDCommand("O2_B2S3"                    , "O2: Bank 2 - Sensor 3 Voltage"           , "011A", 2, decoder=None, fast=True),
    OBDCommand("O2_B2S4"                    , "O2: Bank 2 - Sensor 4 Voltage"           , "011B", 2, decoder=None, fast=True),
    ...
    OBDCommand("RUN_TIME"                   , "Engine Run Time"                         , "011F", 2, decoder=None, fast=True),
    OBDCommand("PIDS_B"                     , "Supported PIDs [21-40]"                  , "0120", 4, decoder=None, fast=True),
    OBDCommand("DISTANCE_W_MIL"             , "Distance Traveled with MIL on"           , "0121", 2, decoder=None, fast=True),
    OBDCommand("FUEL_RAIL_PRESSURE_VAC"     , "Fuel Rail Pressure (relative to vacuum)" , "0122", 2, decoder=None, fast=True),
    OBDCommand("FUEL_RAIL_PRESSURE_DIRECT"  , "Fuel Rail Pressure (direct inject)"      , "0123", 2, decoder=None, fast=True),
