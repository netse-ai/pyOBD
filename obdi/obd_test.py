...
obd = OBDI(baudrate=115200, timeout=0.1)
obd.connect()

obd.interface.monitor_all()

# sl = open('speed_log.txt5', 'w')
# rl = open('rpm_log.txt5', 'w')
# el = open('enginer_load_log.txt5', 'w')
# cl = open('enginer_coolant_load_log.txt5', 'w')
#
# cmds = {
